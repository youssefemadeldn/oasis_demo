...
const String _kPolicyholderName = 'Ahmed Al-Otaibi';
const String _kPolicyholderInitials = 'AO';
const String _kMaskedNationalId = '•••• 4821';
const String _kPhone = '+966 55 123 4567';
const String _kEmail = 'ahmed.otaibi@email.com';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DsTopBar(title: 'profile.title'.tr()),
      body: SafeArea(
        top: false,
